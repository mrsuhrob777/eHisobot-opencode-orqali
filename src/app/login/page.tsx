            ...
            <div className="flex gap-1.5">
              {(["uz", "en", "ru"] as Lang[]).map((l) => (
                <button key={l} onClick={() => switchLang(l)}
                  className={`touch-target rounded-lg px-4 text-xs font-semibold tracking-wide transition-all duration-200 ${lang === l ? "bg-blue-600 text-white shadow-md shadow-blue-600/30" : "bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-700"}`}>{l.toUpperCase()}</button>
              ))}
            </div>
          </div>
          ...
          <form action={action} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input name="login" type="text" placeholder="login" className="w-full rounded-xl border border-gray-300 bg-white py-3 pl-10 pr-4 text-sm outline-none transition-all duration-200 placeholder:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 min-h-[44px]" />
              </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input name="password" type="password" placeholder="••••••" className="w-full rounded-xl border border-gray-300 bg-white py-3 pl-10 pr-4 text-sm outline-none transition-all duration-200 placeholder:text-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 min-h-[44px]" />
              </div>
            ...
            <button type="submit" disabled={pending} className="group relative w-full overflow-hidden rounded-xl bg-blue-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-600/30 transition-all duration-200 hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-600/40 disabled:opacity-50 min-h-[44px]">
            ...
            <div className="grid grid-cols-2 gap-2">
              {demoAccounts.map((acc) => {
                ...
                return (
                  ...
                  }} className="touch-target flex items-center gap-2.5 rounded-xl bg-white px-3.5 text-xs font-medium text-gray-700 shadow-sm transition-all duration-200 hover:bg-blue-50 hover:text-blue-700 hover:shadow-md hover:border-blue-200 border border-gray-100/80 group">
